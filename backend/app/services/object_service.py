...
class ObjectService:
    ...
    def get_all_objects(self) -> ObjectListResponses:
        objects = self.object_repository.get_all()
        object_response = [ObjectResponse.model_validate(obj) for obj in objects]
        return ObjectListResponses(objects = object_response, total = len(objects))
    ...
    def get_object_by_id(self, object_id: int ) -> ObjectResponse:
        ...
        return ObjectResponse.model_validate(object)

    def get_objects_by_client(self, client_id: int) -> ObjectListResponses:
        ...
        return ObjectListResponses(objects=object_responses, total=len(object_responses))
    ...
    def get_objects_by_category(self, category: str) -> ObjectListResponses:
